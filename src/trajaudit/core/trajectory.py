...
:class:`~trajaudit.core.events.ReasoningEvent`,
:class:`~trajaudit.core.events.ToolCallEvent`,
:class:`~trajaudit.core.events.ObservationEvent`, and
:class:`~trajaudit.core.events.ScoringEvent`. The unified ordered list
...
class StepType(StrEnum):
    ...
    .. deprecated::
       Use the :data:`~trajaudit.core.events.TrajectoryEvent` variants
       (:class:`~trajaudit.core.events.ReasoningEvent`,
       :class:`~trajaudit.core.events.ToolCallEvent`,
       :class:`~trajaudit.core.events.ObservationEvent`,
       :class:`~trajaudit.core.events.ScoringEvent`). Retained for one
...
class FileEdit(BaseModel):
    ...
    .. deprecated::
       Encode as a :class:`~trajaudit.core.events.ToolCallEvent` (the
       edit invocation) followed by a
       :class:`~trajaudit.core.events.ObservationEvent` carrying the
...
class ShellCommand(BaseModel):
    ...
    .. deprecated::
       Encode as a :class:`~trajaudit.core.events.ToolCallEvent`
       (``tool_name="shell"``) followed by a
       :class:`~trajaudit.core.events.ObservationEvent` carrying
