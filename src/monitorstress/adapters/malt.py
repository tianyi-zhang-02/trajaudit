...
:class:`~monitorstress.core.trajectory.Trajectory` populated with discriminated
:data:`~monitorstress.core.events.TrajectoryEvent` variants.
...
from monitorstress.core.trajectory import HarnessResult, Trajectory
