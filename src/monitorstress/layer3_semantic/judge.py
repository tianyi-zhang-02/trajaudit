...
1. Builds prompt messages via :mod:`monitorstress.layer3_semantic.prompts`,
   incorporating Layer 1 and Layer 2 findings as context.
2. Queries the tier-1 provider for a
   :class:`~monitorstress.core.verdict.SemanticVerdict`.
3. Consults
   :class:`~monitorstress.layer3_semantic.escalation.EscalationPolicy` to
...
:class:`~monitorstress.core.verdict.SemanticVerdict` per trajectory —
...
from monitorstress.core.verdict import SemanticVerdict, SyntacticFinding, WorkspaceFinding
