...
:class:`~monitorstress.core.verdict.AuditVerdict` and feed the Layer 3
judge as context.

Submodules:

* :mod:`monitorstress.layer1_workspace.sandbox` — Docker sandbox.
* :mod:`monitorstress.layer1_workspace.fs_differ` — filesystem diff.
* :mod:`monitorstress.layer1_workspace.process_tracer` — subprocess tracing.
"""
